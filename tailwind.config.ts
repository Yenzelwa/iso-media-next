...
const config: Config = {
  ...
  theme: {
    ...
    colors: {
        ...
        app: {
          dark: "#0e0d0d", // Main background
          header: "#171717", // Header background
          card: "#27272a", // Card background
          border: "#404040", // Border color
          gray: "#a3a3a3", // Gray text
          red: "#991b1b", // Red button/brand
          "red-dark": "#7f1d1d", // Red border
          error: "#dc2626", // Error/edit text
        },
        // Modern streaming colors inspired by Gaia
        gaia: {
          purple: "#6366f1", // Primary accent
          "purple-light": "#8b5cf6", // Light purple
          "purple-dark": "#4338ca", // Dark purple
