...
import PlanDetails from "../app/(root)/profile/PlanDetails";

interface PlanUpgradeModalProps {
  isOpen: boolean;
  onClose: () => void;
  selectedPlan: any; // Prefer a better type than `any`
  currentPlan: {
    id: string;
    name: string;
    price: string;
...
const UpdatePaymentModal: React.FC<PlanUpgradeModalProps> = ({
  isOpen,
  onClose,
  selectedPlan,
  currentPlan,
...
function onSave(arg0: { cardNumber: string; expiryDate: string; cvv: string; nameOnCard: string; }) {
