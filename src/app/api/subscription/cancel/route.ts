...
export async function POST(req: Request) {
  try {
    ...
    const SubscriptionCancelRequestSchema = require('@/schemas/plans/SubscriptionCancelRequest.schema.json');
    validate(SubscriptionCancelRequestSchema, body);
    
    const data = await cancelSubscriptionService(body);
