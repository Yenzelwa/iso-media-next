...
const WatchVideo = ({ params }: { params: { id: string } }) => {
  ...
  async function updateLikes(like: boolean) {
    try {
      ...
      setError('Error occured updating likes');
    }
    ...
    <div className="relative">
      ...
      <section className="p-4">
        ...
        <div className="flex items-center space-x-4 pt-4">
          ...
          <div className="relative">
            <button aria-label="thumbs-up" onClick={() => updateLikes(!currentVideo?.user.like)} className=" left-0 bg-gray rounded-full text-white px-4 py-2 z-10">
            ...
            <button aria-label="thumbs-down" onClick={() => updateDisLikes(!currentVideo?.user.dislike)} className=" right-0 bg-gray rounded-full text-white px-4 py-2 z-10">
